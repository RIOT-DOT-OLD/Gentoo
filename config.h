...
//background color
static const char col_gray1[]       = "#000000"; // #010101 for brownbg
...
static const char col_cyan[]        = "#080808"; // #cb9983 for brownbg
...
static const char *tags[] = { "α", "β", "γ", "δ", "ζ" };
...
/* commands */
static char dmenumon[2] = "0"; /* component of
...
//run xonotic
static const char *xoncmd[] = { "xonotic-taskset", NULL };
//run firefox
static const char *firecmd[] = { "firefox-taskset", NULL };
//run psst
static const char *psstcmd[] = { "psst", NULL };
//run steam
static const char *steamcmd[] = { "steam-taskset", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_x,      spawn,	   {.v = xoncmd } },
	{ MODKEY,                       XK_d,      spawn,          {.v = dmenucmd } },
	{ MODKEY,			XK_p,	   spawn,	   {.v = psstcmd } },
